...
class ChocolateyInstaller(QtWidgets.QWidget):
    ...
    def initUI(self):
        self.label = QtWidgets.QLabel('Enter application name:')
        ...
        self.updateButton = QtWidgets.QPushButton('Update All Apps')
    ...
    def installPackage(self, item):
        ...
        reply = QtWidgets.QMessageBox.question(self, 'Application Installation', f"{package_name} Are you sure you want to install the application?",QtWidgets.QMessageBox.StandardButton.Yes | QtWidgets.QMessageBox.StandardButton.No, QtWidgets.QMessageBox.StandardButton.No)
        if reply == QtWidgets.QMessageBox.StandardButton.Yes:
            self.progress = QtWidgets.QProgressDialog(
                "Application Installation", "Cancel", 0, 100, self)
    ...
    def updateAll(self):
        reply = QtWidgets.QMessageBox.question(self, 'Update All Apps', "Are you sure you want to update all apps?", QtWidgets.QMessageBox.StandardButton.Yes | QtWidgets.QMessageBox.StandardButton.No, QtWidgets.QMessageBox.StandardButton.No)
        if reply == QtWidgets.QMessageBox.StandardButton.Yes:
            self.progress = QtWidgets.QProgressDialog("Update All Apps", "Cancel", 0, 100, self)
